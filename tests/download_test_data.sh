...
# Make fastq files
samtools bam2fq tests/test_data/SRX6427717_hg38.bam -1 tests/test_data/SRX6427717_hg38_1.fastq -2 tests/test_data/SRX6427717_hg38_2.fastq
...
cp tests/test_data/SRX6427717_hg38.R1.fastq tests/test_data/SRX6427717_cp_hg38.R1.fastq 
cp tests/test_data/SRX6427717_hg38.R2.fastq tests/test_data/SRX6427717_cp_hg38.R2.fastq 
