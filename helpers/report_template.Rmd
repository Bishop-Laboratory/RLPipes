...
rmap_samples <- file.path(helpers_dir, 'data', 'RMapDB_samples_11_13_2020.csv')
...
xgb_file <- file.path(helpers_dir, 'data', "xgb_DRIP_group_HS_binary_11_17_2020.model")
lm_file <- file.path(helpers_dir, 'data', "lm_DRIP_group_HS_nonbinary_11_17_2020.rda")
rmap_quality <- file.path(helpers_dir, 'data', 'rmap_quality_DRIP_11_17_2020.csv')
```
...
&nbsp;
<hr />
<p style="text-align: center;">RSeq © 2020, <a href="https://gccri.bishop-lab.uthscsa.edu/"  target="_blank">Bishop Lab</a>, UT Health San Antonio</p>
